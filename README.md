...
[Link https://pamgarciaa.github.io/piedra-papel-tijera/](https://pamgarciaa.github.io/piedra-papel-tijera/)
...
- Ejecutar: Abre el archivo index.html en tu navegador web favorito (Chrome, Firefox, Edge, etc.).

  Jugar:

- Haz clic en el botón "Comenzar".

- Espera la animación de selección (3.5 segundos).
